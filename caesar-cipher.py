#una funcion recibe parametros o variables para realizar una tarea específica

#creamos la función llamada suma
...
#convertir a numero
a=int(a)
#cramos b con lo que diga el usuario
